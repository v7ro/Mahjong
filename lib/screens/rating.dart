...
class RatingScreen extends StatefulWidget {
  ...
  @override State<RatingScreen> createState() => _State();
}

class _State extends State<RatingScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    appBar: AppBar(
      ...
      title: Text(tr('рейтинг','rating'), style: TextStyle(fontFamily: AppLocale().isRu ? 'Cormorant' : 'Aboreto', fontWeight: FontWeight.bold, fontSize: 32, color: kBurgundy)),
      bottom: TabBar(
        controller: _tabs,
